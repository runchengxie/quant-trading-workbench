...
test('editorial stylesheet defines the shared Workbench visual system', () => {
  ...
  assert.doesNotMatch(source, /--research-paper:/);
  assert.doesNotMatch(source, /--research-surface:/);
