...
M1_FOUNDATION_TRACKED_FILES = frozenset(
    (
        ...
        ".github/workflows/publish-platform-publication.yml",
        ".github/workflows/publish-rbreaker-snapshot.yml",
        ".github/workflows/publish-research-snapshot.yml",
        ".github/workflows/rbreaker-artifact-and-deploy.yml",
        ".gitignore",
        ".env.example",
        "AGENTS.md",
        "README.md",
        ...
        "apps/dashboard/docs/ai-stock-picker-adapter.md",
        "apps/dashboard/docs/platform-publication.md",
        "packages/niu-men-line-strategy/README.md",
        "packages/research-core/README.md",
        "pyproject.toml",
        "package.json",
        ...
        "scripts/publish_platform_publication.py",
